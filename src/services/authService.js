...
export const authService = {
  ...
  requestPasswordOtpLogout: (payload) => apiClient.post(ENDPOINTS.auth.requestPasswordOtpLogout, payload, publicRequest),
  confirmPasswordOtp: (payload) => apiClient.post(ENDPOINTS.auth.confirmPasswordOtp, payload, publicRequest),
