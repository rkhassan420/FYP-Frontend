...
const Login = ({ role }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await authService.studentLogin({ email: trimmedEmail, password });
      ...
      <div className="login-wrapper">
        <div className="login-card">
          ...
          <form onSubmit={handleLogin} className="login-form">
            ...
            <span className="forgot" onClick={() => navigate("/student/password-forgot")}>
              Forgot Password?
            </span>
          ...
          <p className="signup-link">
            ...
            <span onClick={() => navigate("/signup/student")}>Sign Up</span>
          </p>
        </div>
      </div>
    </div>
