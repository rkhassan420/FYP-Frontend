...
export default function StudentSidebar() {
  ...
  // Derive active page from URL — e.g. /student/dashboard/my-classes → "my-classes"
  ...
  const handleLogout = async () => {
    ...
    if (refresh) {
      try {
        ...
        // still clear session if token expired
      }
    }
    clearAuthSession();
    localStorage.removeItem("studentSidebarCollapsed");
  ...
  return (
    <aside className={`teacher-sidebar ${collapsed ? "collapsed" : ""}`}>
        ...
        {collapsed ? (
          ...
          <>
            ...
            <div className="teacher-sidebar-title-container">
              ...
              <div className="teacher-sidebar-subtitle">Student Portal</div>
            </div>
            <button
              className="teacher-collapse-btn"
              onClick={() => setCollapsed(true)}
      ...
      <nav className="teacher-sidebar-nav">
        <div
          className={`teacher-nav-item ${activePage === "overview" ? "active" : ""}`}
