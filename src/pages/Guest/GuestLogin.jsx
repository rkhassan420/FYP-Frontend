...
const GuestLogin = ({ role }) => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await authService.guestLogin({ email: trimmedEmail, password });      
      ...
      <div className="login-wrapper">
        <div className="login-card">
          ...
          <form onSubmit={handleLogin} className="login-form">
            ...
            <span className="forgot" onClick={() => navigate("/guest/forgot-pass")}>
              Forgot Password?
            </span>
          ...
          <p className="signup-link">
            ...
            <span onClick={() => navigate("/guest/signup")}>Sign Up</span>
          </p>
        </div>
      </div>
    </div>
